...
public class IssueNewListView extends ListView implements
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				...
				mImg = (ImageView) convertView
						.findViewById(R.id.busker_join_image_2);
				mTeamname = (TextView) convertView
						.findViewById(R.id.busker_join_teamname_2);
				mRanking = (TextView) convertView
						.findViewById(R.id.busker_join_ranking_2);
				mTime = (TextView) convertView
						.findViewById(R.id.team_time_info);
			...
			m_oAsyncImageLoader.setImageDrawableAsync(holder.img,
					itemObject.getTeamThum(), default1, default1, mContext);
