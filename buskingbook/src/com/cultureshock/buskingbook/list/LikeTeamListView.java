...
public class LikeTeamListView extends ListView implements HttpClientNet.OnResponseListener
{
	...
	public LikeTeamListView(Context context) {
		super(context);
		mContext = context;
		initListView();
	}
	public void setListData(ArrayList<TeamObject> list,ArrayList<Integer> ranking) 
	{
	...
	public LikeTeamListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
