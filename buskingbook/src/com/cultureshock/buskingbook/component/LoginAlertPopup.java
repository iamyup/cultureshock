...
public class LoginAlertPopup extends LinearLayout {
	...
	public LoginAlertPopup(Context context) {
	...
	private void initView() {
		...
		v = inflater.inflate(R.layout.popup_login_alert, null);
		this.addView(v);
		...
		m_oBtnConfirm= (ImageView)v.findViewById(R.id.popup_modify_myalbum_btn_confirm);
		m_oBtnConfirm.setOnClickListener(BtnConfirm);
		m_oBtnCancel =  (ImageView)v.findViewById(R.id.popup_modify_myalbum_btn_cancel);
