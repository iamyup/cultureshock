...
//				{
//					//중복되는아이디가 없을시
//					m_oTxtDoble.setText("사용 가능한 팀명 입니다.");
//					Toast.makeText(this, "사용 가능한 팀명 입니다.", Toast.LENGTH_SHORT).show();
//					checkDouble = true;
//				}
//				else
//				{
//					m_oTxtDoble.setText("중복된 팀명이 있습니다.");
//					Toast.makeText(this, "중복된 팀명이 있습니다.", Toast.LENGTH_SHORT).show();
//					checkDouble = false;
//					//얼랏 중복되니 다시 입력바랍니다.
//				}
			}
