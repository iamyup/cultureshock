...
public class BuskerSearchListView extends ListView implements HttpClientNet.OnResponseListener
{
	private Context mContext;
	private BuskerSearchAdapter listAdapter;
	...
	public BuskerSearchListView(Context context) {
		super(context);
		mContext = context;
		initListView();
	}
	public void setListData(ArrayList<TeamObject> list) 
	{
		...
		listAdapter = new BuskerSearchAdapter(teamObject);
		setAdapter(listAdapter);
	}
	public BuskerSearchListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	...
	class BuskerSearchAdapter extends ArrayAdapter<TeamObject> 
	{
		...
		public BuskerSearchAdapter(List<TeamObject> objects) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
	    	...
	    	holder.ranking.setText("TOP"+(position+1));
